...
function saveRegistry(){
  if(!GH_OWNER)return;
  // Save full registry WITH botTokens  supervisor needs them
  // bot-factory repo is private, tokens are safe
  githubUpdate(GH_OWNER,'bot-factory','bots.json',Buffer.from(JSON.stringify(registry,null,2))).catch(function(){});
}
